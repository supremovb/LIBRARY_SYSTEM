                ...
                <?php if (session()->get('role') === 'librarian'): ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="booksDropdown">
                            <li><a class="dropdown-item" href="<?= base_url('librarian_dashboard/categories') ?>"><i class="bx bx-category"></i> Categories</a></li>
                ...
                <?php if (session()->get('logged_in')): ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="userDropdown">
                            <li><a class="dropdown-item" href="<?= session()->get('role') === 'librarian' ? base_url('librarian/view-profile') : base_url('student/view-profile') ?>"><i class="bx bx-id-card"></i> View Profile</a></li>
        ...
        <div class="modal fade" id="editCategoryModal" tabindex="-1" aria-labelledby="editCategoryModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="editCategoryForm" method="POST" action="<?= base_url('librarian/update-category') ?>">
                        <?= csrf_field() ?>
        ...
        <div class="modal fade" id="addCategoryModal" tabindex="-1" aria-labelledby="addCategoryModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="addCategoryForm" method="POST" action="<?= base_url('librarian/add-category') ?>">
                        <?= csrf_field() ?>
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="categoryName">Category Name</label>
            ...
            $('.delete-category').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = '<?= base_url('librarian/delete-category/') ?>' + categoryId;
                    }
                });
            });
