...
<head>
    ...
    <title>Edit Book - librarian</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form id="editBookForm" action="<?= site_url('librarian/update-book') ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field() ?>
    ...
    <script>
        $('#editBookForm').submit(function(e) {
            ...
            $.ajax({
                url: '<?= site_url("librarian/update-book") ?>',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                success: function(response) {
                    ...
                    if (response.status === 'success') {
                        Swal.fire(
                            ...
                            window.location.href = '<?= site_url("librarian_dashboard") ?>'; 
                        });
