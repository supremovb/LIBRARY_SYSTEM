...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('librarian_dashboard') ?>" class="nav-link"><i class="bx bx-home"></i> Dashboard</a>
                </li>
                ...
                <?php if (session()->get('role') === 'librarian'): ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="booksDropdown">
                            <a class="dropdown-item" href="<?= base_url('librarian/categories') ?>"><i class="bx bx-list-ul"></i> Categories</a>
                            <a class="dropdown-item" href="<?= base_url('librarian/add-category') ?>"><i class="bx bx-plus"></i> Add Category</a>
                            <a class="dropdown-item" href="<?= base_url('librarian/create-book') ?>"><i class="bx bx-plus"></i> Add Book</a>
                ...
                <?php if (session()->get('logged_in')): ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="userDropdown">
                            <a class="dropdown-item" href="<?= session()->get('role') === 'librarian' ? base_url('librarian/view-profile') : base_url('student/view-profile') ?>"><i class="bx bx-user"></i> View Profile</a>
        ...
        function deleteUser(userId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch('<?= base_url('librarian/delete-user') ?>', {
                            method: 'POST',
                            headers: {
    ...
    <script>
        document.getElementById('editRoleForm').addEventListener('submit', function(e) {
            ...
            fetch('<?= base_url('librarian/edit-role') ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
