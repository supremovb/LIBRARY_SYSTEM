...
<body>
    <div class="container mt-5">
        ...
        <h2><i class="bx bx-home"></i> Librarian Dashboard</h2>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                <a href="librarian_dashboard/edit-book/<?= esc($book['book_id']) ?>" class="btn btn-primary btn-sm">
        ...
        $('.delete-btn').click(function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'librarian/delete-book/' + book_id,
                        type: 'POST',
                        data: {
                            _method: 'DELETE',
                            book_id: book_id
