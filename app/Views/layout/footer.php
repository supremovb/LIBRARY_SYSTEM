...
.content {
    flex: 1; /* Allow the main content area to take up the remaining space */
    display: flex;
...
.footer {
    position: absolute; /* Position footer at the bottom of the page */
    bottom: 0;
    width: 100%; /* Ensure footer takes full width */
    padding: 10px 0; /* Adjust padding for footer */
    background-color: #f8f9fa; /* A subtle background for the footer */
    text-align: center; /* Center the text in the footer */
        ...
        .footer-nav {
    display: flex;
    justify-content: center; /* Center the footer nav horizontally */
    align-items: center;
}
