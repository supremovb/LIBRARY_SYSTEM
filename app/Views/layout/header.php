...
<head>
    ...
    <style>
        ...
        .header {
            ...
            /* Align the logo to the left and right */
            padding: 10px 20px;
            /* Reduced padding for a smaller look */
            background-color: #C1D3FE;
            /* Caramel color background for header */
            position: fixed;
            /* Fix the header at the top */
            top: 0;
            width: 100%;
            /* Make the header span across the full width of the page */
            z-index: 1000;
        ...
        body {
            padding-top: 70px;
            /* Adjusted to match the smaller header */
            margin: 0;
